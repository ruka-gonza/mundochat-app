...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // =========================================================================
    // Inicializa la conexión del socket con opciones para mejorar la reconexión.
    state.socket = io({
        reconnectionAttempts: 5, // Intenta reconectar hasta 5 veces si se pierde la conexión
        timeout: 10000           // Tiempo de espera de 10 segundos para la conexión inicial
    });
    // =========================================================================
